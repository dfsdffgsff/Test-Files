...
def test_BUG323(client, authenticated_user):
...
def test_BUG324(client, authenticated_user):
...
def test_BUG325(client, authenticated_user):
...
def test_BUG327(client, auth_headers):
