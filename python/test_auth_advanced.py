...
def BUG302(client, registered_user):
...
def BUG303(client, registered_user):
...
def BUG301(client, registered_user):
...
def BUG305(client, registered_user):
...
def BUG306(client, registered_user):
...
def BUG307(client, registered_user):
...
def BUG308(client, registered_user):
